...
// TODO: Rename SampleOfferWithoutReward -> Offer,
//              SampleOffer -> OfferWithReward?
contract SampleOfferWithoutReward {
    ...
    // signed.
    // Set once by the Offerer.
    // TODO: Rename to `initialWithdraw`
    ...
    // TODO: What makes the Client to increase that?
    uint public dailyWithdrawLimit;

    // The address of the Contractor.
    address public contractor;

    // Address of the Proposal/Offer document.
    // TODO: Can we consider that being an URL? The DAO can audit that the
    //       document pointed by the URL is not mutable.
    ...
    // TODO: This function is quite inconvenient. See withdraw() alternative.
    function getDailyPayment() {
        if (msg.sender != contractor) // TODO: This check is not needed.
            throw;
    ...
    function withdraw() {
        var daysSinceSignoff = now - dateOfSignature; // TODO: Can be negative?
        // FIXME: The amount ignores hirtorical changes to dailyWithdrawLimit.
        var amount = (oneTimeCosts + daysSinceSignoff * dailyWithdrawLimit) - paidOut;
        if (contractor.send(amount))
            paidOut += amount;
    }
